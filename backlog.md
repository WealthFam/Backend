...
## 🟢 UI/UX Enhancements
1. **[DONE] Transactions List Polish**: Since category icons are already shown, remove the "Category Name" text from the Description column to reduce clutter. Show the name on hover via tooltip.
...
23. **[DONE] Theme Switcher**: Implement a robust Dark/Light mode toggle in the Top Bar using Vuetify's theme system.
