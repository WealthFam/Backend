            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(item.amount < 0 ? 'DEBIT' : 'CREDIT', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 0.5, color: (item.amount < 0 ? AppTheme.danger : AppTheme.success).withOpacity(0.5))),
                ],
              ),
            ],
          ),
